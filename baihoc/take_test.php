...
if ($_SESSION['student_id'] != 1) {
    echo "<script>alert('Bạn không có quyền truy cập bài test này!'); window.location.href = 'login.php';</script>";
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['answer'])) {
    ...
    if ($_SESSION['current_index'] >= $total_questions) {
        ...
        $conn->close();
        header("Location: take_test.php?test_id=" . $test_id . "&question=" . ($_SESSION['current_index'] + 1));
        exit();
    }
}
        ...
        <div class="quiz-container">
            ...
            <?php if ($total_questions > 0): ?>
                ...
                <div class="question">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="take_test.php?test_id=<?php echo $test_id; ?>&question=<?php echo $current_index; ?>">

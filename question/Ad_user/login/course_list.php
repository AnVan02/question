                ...
                foreach($allowed_courses as $course_id) {
                    ...
                    if ($course) {
                        ...
                        if ($course['ten_test']) {
                            ...
                            echo "<p><strong>Số lần thử:</strong> " . $course['lan_thu'] . "</p>";
                            echo "<p><strong>Điểm đạt:</strong> " . $course['Pass'] . "%</p>";
                            echo "<p><strong>Số câu hỏi:</strong> " . $course['so_cau_hien_thi'] . "</p>";
                            
                            // Chuyển đổi tên khóa học thành tên file
                            $course_file = getCourseFileName($course['khoa_hoc']);
                            echo "<a href='../login/" . $course_file . "' class='start-btn'>Bắt đầu học</a>";
                        } else {

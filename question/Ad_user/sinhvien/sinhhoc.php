...
<body>
    <div class="container">
        <?php if ($current_index < count($_SESSION['questions'])): ?>
            ...
            <form method="POST" action="">
                <div class="question-box">
                    ...
                    <div class="btn-area">
                        <button type="submit" name="goBack" <?php echo $current_index == 0 ? 'disabled' : ''; ?>>Câu tiếp</button>
                        <button type="submit" name="skip" <?php echo $current_index == count($_SESSION['questions']) - 1 ? 'disabled' : ''; ?>>Câu sau</button>
                    </div>
        ...
        <?php else: ?>
            ...
            // kiểm tra kêt qua
            $question_ids =[]; 
            if (!empty ($tt_bai_test) && $tt_bai_test !== 'Không có câu tra lời nào') {

...
<body>
    <div class="container">
        <?php if ($current_index < count($_SESSION['questions'])): ?>
            <!-- Hiển thị kết quả lần thử gần nhất -->
            <div class="last-attempt">
                
                <h3>Kết quả lần thử gần nhất</h3>
                <p><strong>Điểm:</strong> <?php echo htmlspecialchars($last_attempt_score); ?> / <?php echo count($_SESSION['questions']); ?></p>
                <p><strong>Số lần thử:</strong> <?php echo htmlspecialchars($attempts); ?> / <?php echo $max_attempts; ?></p>
            </div>
        ...
        <?php else: ?>
            ...
            <h3>Kết quả bài test gần nhất </h3>
            ...
            <div class="navigation-actions" style="display: flex; align-items: center;">
                <a class="nav-link" style="margin-left: 72%; text-decoration: none; padding: 8px 14px; background-color: #3182ce; color: white; border-radius: 5px;">
                    Bắt đầu làm bài 
                </a>
            </div>
                    ...
                    <div class="question-block">
                        ...
                        <div class="explanation-block" style="border-color: <?php echo isset($answers[$index]) && $answers[$index]['is_correct'] ? '#28a745' : '#dc3545'; ?>;">
                            <?php if (isset($answers[$index]['selected']) && !$answers[$index]['is_correct']): ?>
                                <!-- <p><strong>Đáp án đúng:</strong> <?php echo htmlspecialchars($question['correct']); ?> - <?php echo htmlspecialchars($question['choices'][$question['correct']]); ?></p> -->
            ...
            <div class="navigation-actions" style="display: flex; align-items: center;">
                <form method="POST" action="">
                    <button type="submit" name="reset" value="1" <?php echo $_SESSION['attempts'] >= $max_attempts ? 'disabled' : ''; ?>>
                        🔁 Làm lại (<?php echo $_SESSION['attempts']; ?> / <?php echo $max_attempts; ?>)
                    </button>
                </form>

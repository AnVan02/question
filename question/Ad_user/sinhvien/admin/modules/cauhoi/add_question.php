...
<body>
    <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <img id="image_preview" src="" style="display:none,margin-left:10px;vertical-align:middle;border-radius:10px;" alt="Preview">
            <button type="button" id="remove_image_btn" style="display:none;margin-left:10px;vertical-align:middle;" onclick="removeNewImage('image_input','image_preview','remove_image_btn')">✘</button>
            <?php if (!empty($question_data['hinhanh'])): ?>
                <div class="existing-image question-image">
                    ...
                    <button type="button" onclick="removeImage(this, 'delete_image', 'question-image')">X</button>
                </div>
            <?php endif; ?>
            ...
            foreach ($options as $opt): $opt_lc = strtolower($opt); ?>
                ...
                <img id="image_preview_<?= $opt_lc ?>" src="" style="display:none;margin-left:10px;vertical-align:middle;border-radius:10px;" alt="Preview">
                <button type="button" id="remove_image_btn_<?= $opt_lc ?>" style="display:none;margin-left:10px;vertical-align:middle;" onclick="removeNewImage('image_input_<?= $opt_lc ?>','image_preview_<?= $opt_lc ?>','remove_image_btn_<?= $opt_lc ?>')">✘</button>
                <?php if (!empty($question_data["hinhanh_" . $opt_lc])): ?>
                    <div class="existing-image answer-image-<?= $opt_lc ?>">
                        ...
                        <button type="button" onclick="removeImage(this, 'delete_image_<?= $opt_lc ?>', 'answer-image-<?= $opt_lc ?>')">✘</button>
                    </div>
                <?php endif; ?>

...
<head>
    ...
    <style>
        ...
        .left-column, .right-column {
            flex: 1; /* Chia đều không gian, cột trái cố định, cột phải tự điều chỉnh */
        }

        .left-column {
            flex-basis: 40%; /* Độ rộng cố định cho cột trái */
            min-width: 0; /* Đảm bảo không bị tràn */
        }

        .right-column {
            flex-basis: 60%; /* Độ rộng còn lại cho cột phải */
            min-width: 0; /* Đảm bảo không bị tràn */
        }
                ...
                while ($test = $result3->fetch_assoc()) {
                    ...
                    echo "<li>
                        ...
                        <div class='test-actions'>
                            <a href='?student_id=$student_id&khoa_hoc_id=$khoa_hoc_id&xem_cau_hoi={$test['id_test']}'>Câu hỏi</a>
                ...
                if ($quiz_result->num_rows == 0) {
                    ...
                    while ($q = $quiz_result->fetch_assoc()) {
                        ...
                        if ($user_answer !== null) {
                            ...
                            echo "<p>Đáp án đúng: <strong>$dap_an_dung</strong></p>";
                            echo "</div>";
                        } else {
                            echo "<div class='answer-info'>";

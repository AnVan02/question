...
<body>
    <div class="container">
        ...
        <?php else: ?>
            ...
            <p><strong>Điểm cao nhất:</strong> <?php echo htmlspecialchars($kq_cao_nhat) ?> / <?php echo $max_attempts; ?></p>
            <p><strong>Số lần thử:</strong> <?php echo htmlspecialchars($_SESSION['so_lan_thu']); ?> / <?php echo $max_attempts; ?></p>

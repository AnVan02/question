<?php
// Lấy danh sách câu hỏi còn lại sau khi xóa
// Tính toán lại điểm số dựa trên các câu trả lời của học sinh chỉ cho những câu hỏi còn tồn tại
// Cập nhật điểm số mới vào database

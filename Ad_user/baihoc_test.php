...
<body>
    ...
    <form method="POST" enctype ="mutipart/from-data">
        ...
        <label >Mức độ</label>
        <select name="correct" class ="custom-select">
            <option value="Khó"<?= ($question_data['loai_mucdo'  ]??'') == 'loai_mucdo '? 'selected':''?>> Khó</option>
            <option value="Bình thường"<?= ($question_data['loai_mucdo']?? '')== 'loai_mucdo' ?'selected': ''?>>Bình thường</option>
            <option value="Dễ" <?= ($question_data['loai_mucdo']?? '')== 'loai_mucdo' ?'selected':''?>> KHó </option>
        </select> 

...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav flex-column">
            ...
            <div class="collapse <?php if (in_array($action, ['aad_khoahoc', 'khoahoc', 'question'])) echo 'show'; ?>" id="products">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item <?php if ($query === 'product_list') echo 'active'; ?>">
                        <a class="nav-link" href="./index.php?admin/add_khoahoc.php">Thêm khoá học</a>
                    </li>
                    
                    <li class="nav-item <?php if ($query === 'product_list') echo 'active'; ?>">
                        <a class="nav-link" href="./index.php?admin/khoahoc.php">Thêm bài kiểm tra</a>
                    </li>

                    <li class="nav-item <?php if ($query === 'questio') echo 'active';?>">
                         <a class="nav-link" href="./index.php?admin/baihoc.php">Thêm bài hoc</a>
                    </li>
                    
                    <li class="nav-item <?php if ($query === 'category_list') echo 'active'; ?>">
                        <a class="nav-link" href="./index.php?admin/add_question.php">Thêm câu hỏi</a>
                    </li>
        ...
        <?php if (isset($_SESSION['account_type']) && $_SESSION['account_type'] == 2): ?>
            ...
            <li class="nav-item >
                <a class="nav-link" href="UI/ad/student.php">

...
<link rel="popup" href="popupkm.php" type="rosacomputer">
                ...
                <ul class="d-flex">
                    ...
                    <li><a href="#">ỨNG DỤNG ROSA <i class="fas fa-chevron-down"></i></a>
                        <ul class="submenu">
                            ...
                            <li class="has-submenu">
                                <a href="/courses/Nextcloud.php">PHẦN MỀM QUẢN TRỊ DOANH NGHIỆP <i class="fas fa-chevron-right"></i></a>
                                <ul class="submenu">
                                    <li><a href="courses/python-course.php">Nexcloud</a></li>
                                    <li><a href="courses/python-course.php">Chatbot AI</a></li>
                                    <li><a href="courses/yolo_course.php">Phâm mềm chấm công </a></li>
                                </ul>
                            </li>                        
                        </ul>
                    </li>
                    ...
                    <li><a href="index.php?page=products&brand_id=4">SẢN PHẨM KHÁC</a></li>

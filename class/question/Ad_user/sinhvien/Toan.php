...
<body>
    <div class="container">
        ...
        <?php else: ?>
            <?php
            // Construct tt_bai_test as "ID_cauhoi:selected_answer;ID_cauhoi:selected_answer"
            $tt_bai_test = '';
            $display_answers = '';
            if (!empty($answers)) {
                $answer_pairs = [];
            ...
            <p><strong>Chi tiết câu trả lời:</strong> <?php echo htmlspecialchars($display_answers); ?></p>
            <hr>

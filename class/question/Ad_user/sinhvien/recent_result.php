...
$required_pass_percent = 70; // Giá trị mặc định
$stmt->close();
        ...
        <?php if ($recent_result): ?>
            ...
            <?php if (!empty($recent_result['test_gan_nhat'])): ?>
                ...
                foreach ($questions as $q) {
                    ...
                    if (!empty($q['image'])) {
                        echo "<img src='admin/" . htmlspecialchars($q['image']) . "' alt='Hình ảnh câu hỏi' class='question-image' onerror='this.style.display=\"none\"'>";
                    }
                    ...
                    foreach ($q['choices'] as $key => $val) {
                        ...
                        if (!empty($q['images'][$key])) {
                            echo "<br><img src='admin/" . htmlspecialchars($q['images'][$key]) . "' alt='Hình ảnh đáp án $key' class='answer-image' onerror='this.style.display=\"none\"'>";
                        }
                        echo "</li>";
                    }
                    echo "</ul>";

...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/4.6.2/js/bootstrap.bundle.min.js"></script>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11518984219"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-11518984219');
</script>

<!-- Event snippet for Lượt xem trang conversion page -->
<script>
  gtag('event', 'conversion', {
      'send_to': 'AW-11518984219/jeuGCIqrp_wZEJuA1_Qq',
      'value': 1.0,
      'currency': 'VND'
  });
</script>
    ...
    <div class="hamburger_menu">
        ...
        <div class="hamburger_menu_content text-right">
            <ul class="menu_top_nav">
                ...
                <li><a href="/check.php">KIỂM TRA ĐƠN HÀNG</a></li>
                <li class="has-submenu">
                    <a href="">AI SOLUTIONS <i class="fas fa-chevron-down"style="margin-left: 15px"></i></a>
                    <ul class="submenu">
                        <li class="has-submenu">
                            <a href="">KHOÁ HỌC AI<i class="fas fa-chevron-down"style="margin-left: 15px"></i></a></a>
                            <ul class="submenu">
                                <li><a href="/ROSA-SW.php">ỨNG DỤNG ROSA</a></li>
                                <li><a href="/courses/python-course.php">PYTHON CƠ BẢN</a></li>
                                <li><a href="/courses/yolo-course.php">THỊ GIÁC MÁY TÍNH</a></li>
                    ...
                    <li class="has-submenu">
                            <a href="">SMB<i class="fas fa-chevron-down" style="margin-left:15px"></i></a>
                            <ul class="submenu">
    ...
    function loadLanguage(lang) {
       ...
       .header {
        ...
        /* Định dạng submenu cấp 2 */
            ...
            .hamburger_menu .has-submenu .submenu {
                left: 0;
                margin-left: 0;
            }

                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul style="margin: 8px 0 0 18px; padding: 0;">
                                        <li<?php if ($question['dap_an'] == 'A') echo ' style="color:green;font-weight:bold"'; ?>>
                                            A. <?php echo htmlspecialchars($question['cau_a']); ?>
                                        </li>
                                        <li<?php if ($question['dap_an'] == 'B') echo ' style="color:green;font-weight:bold"'; ?>>
                                            B. <?php echo htmlspecialchars($question['cau_b']); ?>
                                        </li>
                                        <li<?php if ($question['dap_an'] == 'C') echo ' style="color:green;font-weight:bold"'; ?>>
                                            C. <?php echo htmlspecialchars($question['cau_c']); ?>
                                        </li>
                                        <li<?php if ($question['dap_an'] == 'D') echo ' style="color:green;font-weight:bold"'; ?>>
